...
## [0.14.0](https://github.com/chio-labs/fensu/compare/v0.13.0...v0.14.0) (2026-08-22)
...
* add upstream call mapping ([d90b4dd](https://github.com/chio-labs/fensu/commit/d90b4dddf721815a02c7203126dab140e9a5e133))
* add upstream call mapping ([140f7ff](https://github.com/chio-labs/fensu/commit/140f7ff5d6dac6c437ada126691983dd390b7dbf))
...
* **analysis:** share Python source parsing ([6aeac54](https://github.com/chio-labs/fensu/commit/6aeac541d79827d9a6962b7fb6810f1e930e56ae))
* **analysis:** share Python source parsing ([620664f](https://github.com/chio-labs/fensu/commit/620664fb94844344b526a9efeff053988856599f))
* group the CLI helper container into buckets ([77bc521](https://github.com/chio-labs/fensu/commit/77bc521f3c7c5848fbe221b4e5871dd538448c10))
* **hygiene:** rename rule prefix to SFH ([fc18fa0](https://github.com/chio-labs/fensu/commit/fc18fa0798ca4b91ec8e58759ae0b054c5916e80))
* promote catalogue from a helper to a domain ([6193008](https://github.com/chio-labs/fensu/commit/6193008f364634ec2f7307f9ac29aa102da3fee1))
* promote check from a helper to a domain ([938fda5](https://github.com/chio-labs/fensu/commit/938fda55a805a0a17784696e3c15aeb14711da1f))
* promote hosting from a helper to a domain ([ae1f1d5](https://github.com/chio-labs/fensu/commit/ae1f1d50798fa113f67365b203986e4ba67368ee))
* promote init from a helper to a domain ([8f7e186](https://github.com/chio-labs/fensu/commit/8f7e186691bcc62d5b9568f918908d7865716605))
* promote reporting from a helper to a domain ([c1c5b5d](https://github.com/chio-labs/fensu/commit/c1c5b5d3c5ea71a6112727bd6f81b072a41fde07))
* remove memory experiment ([aacfdc9](https://github.com/chio-labs/fensu/commit/aacfdc9c84682b031cf3eeabd85db46b89658f8a))
* remove memory experiment ([678cbed](https://github.com/chio-labs/fensu/commit/678cbed8c514e62e2230284148ff3fa8bb82bd09))
* rename rust role containers to _helpers ([67d33be](https://github.com/chio-labs/fensu/commit/67d33befaf7c7df9c9e7de544fdf451fdb5cb9fe))
* rename Strata to Fensu ([17c5b35](https://github.com/chio-labs/fensu/commit/17c5b357ef072110e88ba4037caead5ccd4d4166))
* retire Python fallback and core oracles ([6425e1c](https://github.com/chio-labs/fensu/commit/6425e1c1f6c21e8240b9ff2bb199d8ceb55b3583))
* retire Python fallback and core oracles ([fb66609](https://github.com/chio-labs/fensu/commit/fb666095d75168ece6449347ffe192d22aa57e12))
* **rules:** prepare native threshold context ([8e8f2be](https://github.com/chio-labs/fensu/commit/8e8f2be0fc7535fa03e1576d41f30a72bdc586e4))
* **rules:** remove unused assignment target helper ([248e489](https://github.com/chio-labs/fensu/commit/248e4891b38d420202b39bd354e7954737f53e34))
* **structure:** make helper packages private ([3ef259c](https://github.com/chio-labs/fensu/commit/3ef259caf55c584ddbfc878a0df6a6056fe79a48))
* **structure:** make helper packages private ([8921668](https://github.com/chio-labs/fensu/commit/89216687bcf110b849724f8681f5ac4cd9fa65cf))
* **structure:** remove rules spec layer ([0f1f78d](https://github.com/chio-labs/fensu/commit/0f1f78dfd5f0ec42d2d3c7c621095566cc952725))


### Build System

* cross-compile the intel macos wheel and verify windows in ci ([49eda13](https://github.com/chio-labs/fensu/commit/49eda13404ef3b288904ac88288efc618e667795))
* cross-compile the intel macos wheel and verify windows in ci ([5cb54b9](https://github.com/chio-labs/fensu/commit/5cb54b98fb2e65ce7e5c95030370ceb8fa8e5de4))
* publish a windows x86_64 wheel ([65e22a7](https://github.com/chio-labs/fensu/commit/65e22a7d288bedb5598a4c2234e5c3273e252ba8))
* ship stratalint as a single maturin package with a required native backend ([ae4b888](https://github.com/chio-labs/fensu/commit/ae4b888de8d4dc405efb68171fee802b37fcdd6e))
...
* **checkers:** bootstrap vendored enforcement ([a2389d0](https://github.com/chio-labs/fensu/commit/a2389d095047831a25444c6988a97da6988de3f8))
* **checks:** add Ruff and ty enforcement ([a995d10](https://github.com/chio-labs/fensu/commit/a995d1063f5a2f15dc4c439a2ae210f97c47cf9d))
* **dev:** add pre-commit hooks and dev dependencies ([2abac13](https://github.com/chio-labs/fensu/commit/2abac13e257b067787515ffbe537e3fcffb8c65c))
* import Strata history ([f6cbd4e](https://github.com/chio-labs/fensu/commit/f6cbd4e2a9e79a1ed2fcc6a48d44a0c11b43a8dc))
* initialize repository ([4170219](https://github.com/chio-labs/fensu/commit/4170219ed0b48c11beeff9d8caa9db4ad3bc5ca6))
* **main:** release 0.1.0 ([c3276b0](https://github.com/chio-labs/fensu/commit/c3276b0b92d72b2d49d470b97b546db5897c6da5))
* **main:** release 0.1.0 ([6b5d142](https://github.com/chio-labs/fensu/commit/6b5d142af632618d878fe693ab026b5b30048290))
* **main:** release 0.1.1 ([c98e9b6](https://github.com/chio-labs/fensu/commit/c98e9b668f8fdbe2f6ff7b670202e7bc7fa411c3))
* **main:** release 0.1.1 ([83a03df](https://github.com/chio-labs/fensu/commit/83a03df7b8650ea0bc375f76d416f7947134e5c2))
* **main:** release 0.1.2 ([e3beb6d](https://github.com/chio-labs/fensu/commit/e3beb6d1727ca5e066db4151dc7d3c7eca5bd9bf))
* **main:** release 0.1.2 ([d9a55c5](https://github.com/chio-labs/fensu/commit/d9a55c5689b53ec4589cdadf08b786d27fefd983))
* **main:** release 0.10.0 ([7e1a779](https://github.com/chio-labs/fensu/commit/7e1a779e73429d54ceb12c19b83bf7c2a44f0719))
* **main:** release 0.10.0 ([d3e9c11](https://github.com/chio-labs/fensu/commit/d3e9c1185100265deb3b6f1146023c6870925118))
* **main:** release 0.10.0 ([40fcac8](https://github.com/chio-labs/fensu/commit/40fcac89644b16bc688b0c88def2ffedef316b30))
* **main:** release 0.10.0 ([ca70cab](https://github.com/chio-labs/fensu/commit/ca70cab18e240ed98a62d2f24222e6340e86d929))
* **main:** release 0.10.1 ([c201fdb](https://github.com/chio-labs/fensu/commit/c201fdb767b8eb4b3b592f080b19693ae4f090f2))
* **main:** release 0.10.1 ([f4b6f4b](https://github.com/chio-labs/fensu/commit/f4b6f4b76721a302caf23c77c11c06ccdaa9f2c0))
* **main:** release 0.11.0 ([46d185d](https://github.com/chio-labs/fensu/commit/46d185d6144c7e0562fc8b1b132d0df61f010897))
* **main:** release 0.11.0 ([09d4e29](https://github.com/chio-labs/fensu/commit/09d4e298ff32139b4eb6ba3c9cfc705edf240388))
* **main:** release 0.11.0 ([ea1edfd](https://github.com/chio-labs/fensu/commit/ea1edfd0c1e81f37ae9ccce176c7925745b88d04))
* **main:** release 0.11.0 ([a68fa85](https://github.com/chio-labs/fensu/commit/a68fa85eac35fec0ad0fc3d1762400360903973f))
* **main:** release 0.12.0 ([cbd17a1](https://github.com/chio-labs/fensu/commit/cbd17a16d1a1b87e199390222465cfe30d3a4c78))
* **main:** release 0.12.0 ([0950ebf](https://github.com/chio-labs/fensu/commit/0950ebfcbf711125119e067094427d33e62f73d8))
* **main:** release 0.12.0 ([#52](https://github.com/chio-labs/fensu/issues/52)) ([918dd10](https://github.com/chio-labs/fensu/commit/918dd10d9b075f04382a872fdd49b1278a69bc28))
* **main:** release 0.13.0 ([1600f90](https://github.com/chio-labs/fensu/commit/1600f90418014c220666376ad349fe77efe26fc6))
* **main:** release 0.13.0 ([e46df32](https://github.com/chio-labs/fensu/commit/e46df32b209c0c4c7403e1999921ee8766fd7b55))
* **main:** release 0.13.0 ([#56](https://github.com/chio-labs/fensu/issues/56)) ([5700e64](https://github.com/chio-labs/fensu/commit/5700e6467f0c88eb3d17d15a1fd60ee2d97053e8))
* **main:** release 0.14.0 ([e36debd](https://github.com/chio-labs/fensu/commit/e36debde9a2582840cbd55797a35473b539c72c4))
* **main:** release 0.14.0 ([91a83ac](https://github.com/chio-labs/fensu/commit/91a83ac48613d81059d2a5ab3445c2124345ab2a))
* **main:** release 0.15.0 ([e8cd222](https://github.com/chio-labs/fensu/commit/e8cd22272f2426784f84391fad84dbc52668def2))
* **main:** release 0.15.0 ([8e738cd](https://github.com/chio-labs/fensu/commit/8e738cd1c40e25aad64bde0557d127edb9aaeab7))
* **main:** release 0.15.1 ([9341e60](https://github.com/chio-labs/fensu/commit/9341e6099ab81b6b4ae42c28f90f769304e151a8))
* **main:** release 0.15.1 ([92cf451](https://github.com/chio-labs/fensu/commit/92cf451cf0379ec2e543fd412f7e8bc48ae356e4))
* **main:** release 0.15.2 ([d552e7c](https://github.com/chio-labs/fensu/commit/d552e7c9d819377ae8b786f8a68da3ab19b971b1))
* **main:** release 0.15.2 ([ac0de9d](https://github.com/chio-labs/fensu/commit/ac0de9d93e1448645dc5e11f4126cfc8f182cd12))
* **main:** release 0.15.3 ([6a243b3](https://github.com/chio-labs/fensu/commit/6a243b36e000fb6a30e5e3e77c76c73462ac1ecf))
* **main:** release 0.15.3 ([a35a182](https://github.com/chio-labs/fensu/commit/a35a182d324c02c89458e44a4c54f2c52d40ce80))
* **main:** release 0.16.0 ([e298c7e](https://github.com/chio-labs/fensu/commit/e298c7e12a544b971277aa32633ed3687253d34b))
* **main:** release 0.16.0 ([dd10bc7](https://github.com/chio-labs/fensu/commit/dd10bc7bf0a3f3ab9d7e95efea384d51774d7e0b))
* **main:** release 0.17.0 ([c265e2b](https://github.com/chio-labs/fensu/commit/c265e2b55e504cfa4c0447b8585a382f84cb5857))
* **main:** release 0.17.0 ([68695bc](https://github.com/chio-labs/fensu/commit/68695bc4ede913f4ea035abb03c44b45ea9fb8cb))
* **main:** release 0.18.0 ([6b4b69b](https://github.com/chio-labs/fensu/commit/6b4b69b7b27413029b8e87b2361be361931af227))
* **main:** release 0.18.0 ([5780150](https://github.com/chio-labs/fensu/commit/578015048f167d31b7f73ed5cd08cc396f6d554f))
* **main:** release 0.18.1 ([5388c30](https://github.com/chio-labs/fensu/commit/5388c308a89f05137d7e39cb9be500653b59755d))
* **main:** release 0.18.1 ([321f67d](https://github.com/chio-labs/fensu/commit/321f67df24afed751320d81ad5eae8f11077e37e))
* **main:** release 0.19.0 ([34e705a](https://github.com/chio-labs/fensu/commit/34e705ab84d831ff0970ade55b8c43de7754806d))
* **main:** release 0.19.0 ([9bc7058](https://github.com/chio-labs/fensu/commit/9bc7058fd4ada148b6d4eb6767f09eabfae6ca53))
* **main:** release 0.2.0 ([7e85646](https://github.com/chio-labs/fensu/commit/7e856469c3f3997ce3f886508ee5d0795bb855a3))
* **main:** release 0.2.0 ([6f632e2](https://github.com/chio-labs/fensu/commit/6f632e298c27770c8d1920aacf7ee3e193777539))
* **main:** release 0.2.0 ([68a40f9](https://github.com/chio-labs/fensu/commit/68a40f90063da4fbd20de979fb21476d400bd48e))
* **main:** release 0.2.0 ([c82966f](https://github.com/chio-labs/fensu/commit/c82966f0ee0093b4bc5fd782aee6393367d7148f))
* **main:** release 0.2.1 ([2de9bca](https://github.com/chio-labs/fensu/commit/2de9bcab7bb1a0bcc83ec3a3d3541b4c4620b056))
* **main:** release 0.2.1 ([5fe3c46](https://github.com/chio-labs/fensu/commit/5fe3c46ddf8832ff5ec55f955a460e5effedf3f8))
* **main:** release 0.2.2 ([8241de8](https://github.com/chio-labs/fensu/commit/8241de8b551f6e029fa3cb4f9d16cc8a28dbe8b3))
* **main:** release 0.2.2 ([16927ef](https://github.com/chio-labs/fensu/commit/16927ef68aa8389f60567b353ece6978cce87ae8))
* **main:** release 0.20.0 ([67a585e](https://github.com/chio-labs/fensu/commit/67a585e66247526b7f8731f6f01f339d7361e9ff))
* **main:** release 0.20.0 ([561336c](https://github.com/chio-labs/fensu/commit/561336c5235ced6fadc06836f66d715b8f7c2b90))
* **main:** release 0.21.0 ([7e1e15a](https://github.com/chio-labs/fensu/commit/7e1e15ab8c157ff51122c9a3cc7d0d8e5df440cb))
* **main:** release 0.21.0 ([ae19bc2](https://github.com/chio-labs/fensu/commit/ae19bc2615008a74d168d29f71a2f7bc63aa1971))
* **main:** release 0.21.1 ([45d50fe](https://github.com/chio-labs/fensu/commit/45d50fe8b231d63f003f6a286fe7e5d760c1ebc3))
* **main:** release 0.21.1 ([cba2d8c](https://github.com/chio-labs/fensu/commit/cba2d8c478c6976f430bef1210a6bcd626f9c7f9))
* **main:** release 0.3.0 ([a1818a6](https://github.com/chio-labs/fensu/commit/a1818a6b35c1570218c851a6a1f16e09b995ca6e))
* **main:** release 0.3.0 ([9b13af3](https://github.com/chio-labs/fensu/commit/9b13af3f3df222a528b5904b664e8877b25266ab))
* **main:** release 0.3.0 ([1099363](https://github.com/chio-labs/fensu/commit/10993634febccb0eb036a40dfb0d1259da1f8131))
* **main:** release 0.3.0 ([fd75f43](https://github.com/chio-labs/fensu/commit/fd75f437f551fe020ad925eb943cd91df232507d))
* **main:** release 0.4.0 ([8512145](https://github.com/chio-labs/fensu/commit/85121452f50a76542a7f937b4c48e33ccef1d2a1))
* **main:** release 0.4.0 ([7abc21b](https://github.com/chio-labs/fensu/commit/7abc21b01f06adb6f8aff97844dad3b7a3654e9f))
* **main:** release 0.4.0 ([9598cc0](https://github.com/chio-labs/fensu/commit/9598cc059f0136e0389fa49578b66fdad7df795a))
* **main:** release 0.4.0 ([c198db7](https://github.com/chio-labs/fensu/commit/c198db7abb24003d7836099861dd3dcc333756ec))
* **main:** release 0.4.1 ([716c55a](https://github.com/chio-labs/fensu/commit/716c55ac4c3cd39daa023af2d037d2f25f287947))
* **main:** release 0.4.1 ([8d33549](https://github.com/chio-labs/fensu/commit/8d33549a291de11f6a4b52d36e16f1d2a10f9c85))
* **main:** release 0.5.0 ([25dd561](https://github.com/chio-labs/fensu/commit/25dd561e3cc0c29f11f00e30c6b1a186738edb9c))
* **main:** release 0.5.0 ([c545df7](https://github.com/chio-labs/fensu/commit/c545df7507a56a01a0636b225f0ec63b62939723))
* **main:** release 0.5.0 ([3c2b11d](https://github.com/chio-labs/fensu/commit/3c2b11d9f2e8f51cc5cabf28d711d36a9726ee4f))
* **main:** release 0.5.0 ([9df99aa](https://github.com/chio-labs/fensu/commit/9df99aa643d07b35e2097f3d4b4d1be7600aaea6))
* **main:** release 0.5.1 ([fea0e83](https://github.com/chio-labs/fensu/commit/fea0e833f69f2d1d3c0553f61289b16573441684))
* **main:** release 0.5.1 ([6c3ab25](https://github.com/chio-labs/fensu/commit/6c3ab2591440d4ad88f49cf7f48f973779052f2c))
* **main:** release 0.5.2 ([2afb315](https://github.com/chio-labs/fensu/commit/2afb3158266536dbb6211b9614141fc8a1495d48))
* **main:** release 0.5.2 ([9adfa1d](https://github.com/chio-labs/fensu/commit/9adfa1d5574a4e97d7675297ff6408a276d1c679))
* **main:** release 0.6.0 ([5158971](https://github.com/chio-labs/fensu/commit/5158971f8a76d43f5cca9df8dd5fbc87c622f499))
* **main:** release 0.6.0 ([ebea66e](https://github.com/chio-labs/fensu/commit/ebea66ec6fbbf8406e666b9408314f13ef40ccf3))
* **main:** release 0.6.0 ([9ff77ff](https://github.com/chio-labs/fensu/commit/9ff77ffb73113a03f8e10f89c6bb5b054546aa23))
* **main:** release 0.6.0 ([ab9b0e9](https://github.com/chio-labs/fensu/commit/ab9b0e9cb8427532c758ae977624b0dae67e916a))
* **main:** release 0.7.0 ([468c184](https://github.com/chio-labs/fensu/commit/468c184a15fc1e482d8155f9bb166cdeea866fc2))
* **main:** release 0.7.0 ([9da9eaa](https://github.com/chio-labs/fensu/commit/9da9eaa7f0a7b71732eb68cc02db60fd1e1ae395))
* **main:** release 0.7.0 ([1891218](https://github.com/chio-labs/fensu/commit/18912189f12ccb8fc887eb1eb11353f2257fb60b))
* **main:** release 0.7.0 ([cdcb77f](https://github.com/chio-labs/fensu/commit/cdcb77f29a82ed659fe72a3bdaeea51bc9cdd42f))
* **main:** release 0.8.0 ([4d4bc77](https://github.com/chio-labs/fensu/commit/4d4bc77467295f0728bfe8c2f6f1afdc431e5067))
* **main:** release 0.8.0 ([9871a01](https://github.com/chio-labs/fensu/commit/9871a016a5000b10841e1879dfdd33c0d72307c9))
* **main:** release 0.8.0 ([6461eb3](https://github.com/chio-labs/fensu/commit/6461eb34c86f379e7bb6afca793c160be58c622a))
* **main:** release 0.8.0 ([0c8270e](https://github.com/chio-labs/fensu/commit/0c8270e243ac9ac13be657d781a2c99d8319db85))
* **main:** release 0.8.1 ([a7cdf55](https://github.com/chio-labs/fensu/commit/a7cdf55dbbdf4f03b35e629509b8a41afb0186f5))
* **main:** release 0.8.1 ([56be77f](https://github.com/chio-labs/fensu/commit/56be77fc2414156ac60bcb01e8fb59607a494fac))
* **main:** release 0.9.0 ([c8a5d92](https://github.com/chio-labs/fensu/commit/c8a5d92a0d9e7611cf1a4f5566cbc6f7ac3f902a))
* **main:** release 0.9.0 ([eeb24f9](https://github.com/chio-labs/fensu/commit/eeb24f9a309cf4d8abddcc54db24a00cf2604a6e))
* **main:** release 0.9.0 ([3ef1be7](https://github.com/chio-labs/fensu/commit/3ef1be78f67f8e9fa72f4f2626c21ffa6b95e310))
* **main:** release 0.9.0 ([e78aae1](https://github.com/chio-labs/fensu/commit/e78aae1cfa9c6d8ec92b79893bc346b1c720a9e7))
* **main:** release 0.9.1 ([f30dbe2](https://github.com/chio-labs/fensu/commit/f30dbe247b19395404e3011503ba1a551300a8cf))
* **main:** release 0.9.1 ([39a2676](https://github.com/chio-labs/fensu/commit/39a2676062ce1e61dd7041659deca70f2dbf8b66))
* **main:** release 0.9.2 ([e4943be](https://github.com/chio-labs/fensu/commit/e4943be3683e1ccd31f3a1a4477f73e281d1c97b))
* **main:** release 0.9.2 ([a1f23d1](https://github.com/chio-labs/fensu/commit/a1f23d1ccd62ca7b5819100ba6dd19ea26b694b0))
* **main:** release 0.9.3 ([260becc](https://github.com/chio-labs/fensu/commit/260becc1ba5c2b9726e236f8a5320c3529fa06c7))
* **main:** release 0.9.3 ([f2115b4](https://github.com/chio-labs/fensu/commit/f2115b45ffc266c4fcd18322124adaec68b95465))
* **main:** release 0.9.4 ([c5a66da](https://github.com/chio-labs/fensu/commit/c5a66dad5f80a66b8a3eb9504d0b9154bf78bd42))
* **main:** release 0.9.4 ([887d804](https://github.com/chio-labs/fensu/commit/887d8041ca735c3f2acbe00a8b98f022c64666fd))
* **memory:** enable repository dogfooding ([a2aa014](https://github.com/chio-labs/fensu/commit/a2aa014e53c38895fa10fbb850d5f0ab35b0157e))
* raise rust source line limit ([d8ca907](https://github.com/chio-labs/fensu/commit/d8ca907dd40b08e300604d43c16d4d854855d571))
