...
#[test]
fn given_custom_python_rust_and_web_rules_when_checking_then_native_and_hosted_targets_merge() {
    let test_cases = [crate::test_types::RustMixedTargetTestCase {
        description: "custom Python, Rust, and web targets merge with native findings",
        expected_exit_code: 1,
        expected_codes: &["FFA001", "FPRSS010", "XMIX002", "XMIX003"],
    }];
