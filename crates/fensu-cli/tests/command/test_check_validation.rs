...
fn given_invalid_explicit_targets_when_checking_then_configuration_fails_closed() {
    let test_cases = [
        ...
        InvalidCheckConfigTestCase {
            ...
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_roots = []\n",
            expected_exit_code: 2,
            expected_error: "ownership_roots must not be empty",
        },
        InvalidCheckConfigTestCase {
            description: "ownership roots reject non-list values",
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_roots = true\n",
            expected_exit_code: 2,
            expected_error: "ownership_roots must be a list of strings",
        },
        InvalidCheckConfigTestCase {
            description: "removed ownership depth configuration is rejected",
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_depth = 3\n",
            expected_exit_code: 2,
            expected_error: "Unknown targets.app config key(s): ownership_depth",
        },
        InvalidCheckConfigTestCase {
            description: "unused ownership root patterns fail closed",
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_roots = [\"src/pkg/missing/*\"]\n",
            expected_exit_code: 2,
            expected_error: "ownership root pattern matched no directories",
        },
        InvalidCheckConfigTestCase {
            description: "ownership roots must remain below a runtime root",
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_roots = [\"src\"]\n",
            expected_exit_code: 2,
            expected_error: "ownership root must resolve beneath a runtime root",
        },
        InvalidCheckConfigTestCase {
            description: "equal-specificity ownership root declarations fail closed",
            config: "[targets.app]\nanalyzer = \"python\"\nroots = [\"src/pkg\"]\nownership_roots = [\"src/*g\", \"src/p*\"]\n",
            expected_exit_code: 2,
            expected_error: "equal-specificity declarations",
        },
        InvalidCheckConfigTestCase {
