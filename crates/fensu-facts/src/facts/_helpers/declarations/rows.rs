...
use crate::constants;
use crate::facts::_helpers::naming::names::{
...
pub(crate) fn dataclass_rows(
    ...
    for statement in &module.body {
        ...
        let decorator = class.decorator_list.iter().find(|candidate| {
            crate::facts::_helpers::naming::names::decorator_name(&candidate.expression)
        ...
        let shape_name = crate::facts::_helpers::naming::names::decorator_name(shape_expression);
