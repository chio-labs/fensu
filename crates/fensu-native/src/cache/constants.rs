...
pub(crate) const RECORD_SCHEMA_VERSION: i64 = 5;
...
pub(crate) const FILE_SUBJECT_KIND: &str = "file";
pub(crate) const PROJECT_SUBJECT_KIND: &str = "project";
pub(crate) const PROJECT_REQUESTER_PATH: &str = ".fensu-project-rule";
pub(crate) const TREE_GLOB_KIND: &str = "tree_glob";
pub(crate) const DOUBLE_WILDCARD_SEGMENT: &str = "**";
pub(crate) const SINGLE_WILDCARD_SEGMENT: &str = "*";
