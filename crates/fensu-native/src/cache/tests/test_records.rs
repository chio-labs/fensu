...
fn given_invalid_record_when_decoding_then_fails_soft() {
    let test_cases = [
        ...
        InvalidRecordTestCase {
            ...
            data: b"{\"kind\":\"metadata\",\"payload\":{},\"schema_version\":6}",
            expected_kind: "metadata",
            expected_present: false,
        },
        InvalidRecordTestCase {
            description: "wrong kind is rejected",
            data: b"{\"kind\":\"index\",\"payload\":{},\"schema_version\":5}",
            expected_kind: "metadata",
            expected_present: false,
        },
        InvalidRecordTestCase {
            description: "floating payload is rejected",
            data: b"{\"kind\":\"metadata\",\"payload\":1.5,\"schema_version\":5}",
            expected_kind: "metadata",
            expected_present: false,
        },
        InvalidRecordTestCase {
            description: "unknown envelope field is rejected",
            data: b"{\"extra\":true,\"kind\":\"metadata\",\"payload\":{},\"schema_version\":5}",
            expected_kind: "metadata",
            expected_present: false,
        },
        InvalidRecordTestCase {
        ...
        InvalidRecordTestCase {
            ...
            data: b"{\"kind\":\"index\",\"kind\":\"metadata\",\"payload\":{},\"schema_version\":5}",
            expected_kind: "metadata",
            expected_present: false,
        },
    ];
