...
use crate::extension::_helpers::evaluation::{
    execution_planning, reachability_bindings, rule_bindings,
};
...
pub fn _native(module: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    module.add_function(wrap_pyfunction!(
        reachability_bindings::evaluate_python_reachability,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        reachability_bindings::python_reachability_facts,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        reachability_bindings::symbol_pattern_matches,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
        rule_bindings::parse_dead_code_config,
        module
    )?)?;
    module.add_function(wrap_pyfunction!(
