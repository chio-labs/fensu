...
use crate::rules::_helpers::generated_policy::{
    FFT103_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT104_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT104_HELPER_MODULE_FILENAMES, FFT105_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT203_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT204_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT205_SCENARIO_MODEL_FILENAMES, FFT301_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT302_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT401_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT402_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT403_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT404_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT405_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT406_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT407_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT408_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT411_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT412_EXCLUDED_TEST_SUPPORT_FILENAMES, FFT413_EXCLUDED_TEST_SUPPORT_FILENAMES,
    FFT414_EXCLUDED_TEST_SUPPORT_FILENAMES,
};
use crate::rules::_helpers::test_function_conventions::{
    local_test_case_types, test_function_faults,
};
use crate::rules::_helpers::test_layout::{is_layout_code, layout_faults};
use crate::rules::constants::{
    ...
    TEST_LOCAL_TEST_TYPES_FILE_CODE, TEST_LOCAL_TEST_TYPES_IMPORT_CODE, TEST_MIRRORED_ROOT_CODE,
    ...
    TEST_PRIVATE_CONSTANT_ORDER_CODE, TEST_SCENARIO_MODELS_DATACLASSES_CODE, TEST_SCOPE_CODE,
    TEST_SCRIPTS_AREA_EXISTS_CODE, TEST_SCRIPTS_MIRROR_DEPTH_CODE, TEST_SRC_AREA_EXISTS_CODE,
    TEST_SRC_MIRROR_DEPTH_CODE, TEST_SRC_PACKAGE_EXISTS_CODE, TEST_TYPES_DESCRIPTION_CODE,
...
pub(crate) fn test_faults(
    ...
    let file_name = context
        ...
        .next()
        .unwrap_or_default();
    let test_module = !excluded_test_support_filenames(code).contains(&file_name);
    if code == TEST_SCENARIO_MODELS_DATACLASSES_CODE
        && FFT205_SCENARIO_MODEL_FILENAMES.contains(&file_name)
    {
    ...
    let faults = match code {
        ...
        TEST_NO_IF_IN_TESTS_CODE if FFT104_HELPER_MODULE_FILENAMES.contains(&file_name) => {
            location_faults(
                code,
        ...
        TEST_TYPES_DESCRIPTION_CODE if file_name == TEST_TYPES_FILE => program
            .dataclass_rows()
            .iter()
            .filter(|row| !has_description_field(&row.field_names))
            .map(|row| location_fault(code, row.line, row.column))
            .collect(),
        TEST_TYPES_EXPECTED_FIELD_CODE if file_name == TEST_TYPES_FILE => program
            .dataclass_rows()
            .iter()
            .filter(|row| !has_expected_field(&row.field_names))
            .map(|row| location_fault(code, row.line, row.column))
            .collect(),
...
fn has_description_field(names: &[String]) -> bool {
    names.iter().any(|name| name == TEST_DESCRIPTION_FIELD_NAME)
}

fn has_expected_field(names: &[String]) -> bool {
    names
        .iter()
...
fn is_test_code(code: &str) -> bool {
    matches!(
        ...
        TEST_LAYOUT_CODE
            ...
            | TEST_SCENARIO_MODELS_DATACLASSES_CODE
            | TEST_FILE_NAME_CODE
...
fn excluded_test_support_filenames(code: &str) -> &'static [&'static str] {
    match code {
        TEST_NO_TOP_LEVEL_HELPERS_CODE => FFT103_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_NO_IF_IN_TESTS_CODE => FFT104_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_PRIVATE_CONSTANT_ORDER_CODE => FFT105_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_LOCAL_TEST_TYPES_IMPORT_CODE => FFT203_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_LOCAL_TEST_TYPES_FILE_CODE => FFT204_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_FILE_NAME_CODE => FFT301_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_FUNCTION_NAME_CODE => FFT302_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_DATACLASS_PARAMETRIZE_CODE => FFT401_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_ACCEPTS_TEST_CASE_CODE => FFT402_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_CASE_ANNOTATION_CODE => FFT403_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_EXPECTED_FIELD_ASSERTION_CODE => FFT404_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_PARAMETRIZE_ARGUMENTS_CODE => FFT405_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_PARAMETRIZE_TEST_CASE_CODE => FFT406_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_PARAMETRIZE_IDS_CODE => FFT407_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_INLINE_PARAMETRIZE_VALUES_CODE => FFT408_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_NONEMPTY_PARAMETRIZE_VALUES_CODE => FFT411_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_NO_DICT_TEST_CASES_CODE => FFT412_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_LOCAL_TEST_CASE_CONSTRUCTORS_CODE => FFT413_EXCLUDED_TEST_SUPPORT_FILENAMES,
        TEST_DESCRIPTION_LAMBDA_IDS_CODE => FFT414_EXCLUDED_TEST_SUPPORT_FILENAMES,
        _ => &[],
    }
}
