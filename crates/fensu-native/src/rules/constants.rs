...
pub const DAGSTER_ASSET_CALLBACK_SIGNATURE_CODE: &str = "FPDG005";
pub const DAGSTER_IMPORT_BOUNDARIES_CODE: &str = "FPDG006";
pub const DAGSTER_DEFINITION_PUBLIC_SURFACE_CODE: &str = "FPDG007";
pub const DAGSTER_DEFINITION_MODULE_LAYOUT_CODE: &str = "FPDG008";
pub const DAGSTER_PRIVATE_SUPPORT_IMPORTS_CODE: &str = "FPDG009";
pub const DAGSTER_OPERATIONAL_RESOURCE_LAYOUT_CODE: &str = "FPDG010";
pub const DAGSTER_PROVIDER_TYPE_HONESTY_CODE: &str = "FPDG011";
pub const DAGSTER_ASSET_CONFIG_SHAPE_CODE: &str = "FPDG012";
pub const DAGSTER_NO_DYNAMIC_MODULE_REFERENCES_CODE: &str = "FPDG013";
pub const DAGSTER_MODEL_PLACEMENT_CODE: &str = "FPDG014";
pub const DAGSTER_EXCEPTION_PLACEMENT_CODE: &str = "FPDG015";
pub const DAGSTER_PRIVATE_HELPER_BOUNDARY_CODE: &str = "FPDG016";
pub const DAGSTER_PRIVATE_CLASSES_SHAPE_CODE: &str = "FPDG017";
pub const DAGSTER_SOURCE_ROOT_ALLOWLIST_CODE: &str = "FPDG018";
pub const DAGSTER_TOOLING_IMPORT_BOUNDARY_CODE: &str = "FPDG019";
pub const DAGSTER_RUNTIME_PACKAGE_OWNER_CODE: &str = "FPDG020";
pub const DAGSTER_TEST_ROOT_ALLOWLIST_CODE: &str = "FPDG021";
