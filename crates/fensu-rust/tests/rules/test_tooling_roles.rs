    ...
    let test_cases = [
        test_types::CheckRepoTestCase {
            ...
            repo_files: vec![
                ...
                test_types::RepoFile {
                    path: "crates/example-tooling/src/rules/_helpers/policy.rs".to_owned(),
        ...
        test_types::CheckRepoTestCase {
            ...
            repo_files: vec![
                helpers::tooling_entry("rules", "check"),
                test_types::RepoFile {
                    path: "crates/example-tooling/src/rules/policy.rs".to_owned(),
                    contents: "fn policy() -> usize {\n    1\n}\n".to_owned(),
                },
            ],
        ...
        test_types::CheckRepoTestCase {
            ...
            repo_files: vec![
                helpers::tooling_entry("rules", "check"),
                test_types::RepoFile {
                    path: "crates/example-tooling/src/rules/_helpers/rsr706.rs".to_owned(),
                    contents: "fn policy() -> usize {\n    1\n}\n".to_owned(),
                },
            ],
        ...
        test_types::CheckRepoTestCase {
            ...
            repo_files: vec![test_types::RepoFile {
                path: "crates/example-tooling/src/bin/report.rs".to_owned(),
                contents: "fn main() {}\n".to_owned(),
            }],
