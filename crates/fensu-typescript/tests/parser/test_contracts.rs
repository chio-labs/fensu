...
fn given_native_parser_when_reading_contracts_then_versions_are_explicit() {
    ...
    let test_cases = [test_types::ContractTestCase {
        ...
        expected_parser_contract: "typescript-backend-v1",
        expected_cache_contract: "typescript-backend-v1",
        expected_cli_contract_fragment: "Self::TypeScript => \"typescript-backend-v1\"",
    }];
