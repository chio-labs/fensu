...
pub const PUBLIC_MAIN_ENTRY_EXTERNAL_USE_CODE: &str = "SFL105";
...
pub const HELPERS_PACKAGE_LAYOUT_CODE: &str = "SFR301";
pub const MAIN_PACKAGE_LAYOUT_CODE: &str = "SFR302";
...
pub const TOP_LEVEL_DOMAIN_SHAPE_CODE: &str = "SFR306";
pub const SHARED_DOMAIN_PREFIX_CODE: &str = "SFR308";
pub const LEAF_MAIN_BOUNDARY_CODE: &str = "SFR309";
