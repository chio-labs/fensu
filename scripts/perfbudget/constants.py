...
DEFAULT_SEED: int = 0
DEFAULT_UNCACHED_CEILING_SECONDS: float = 0.95
DEFAULT_COLD_CEILING_SECONDS: float = 0.95
DEFAULT_WARM_CEILING_SECONDS: float = 0.16
DEFAULT_EDIT_CEILING_SECONDS: float = 0.7
DEFAULT_VERSION_CEILING_SECONDS: float = 0.03
DEFAULT_INIT_CEILING_SECONDS: float = 0.9
