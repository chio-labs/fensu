...
DEFAULT_SEED: int = 0
DEFAULT_UNCACHED_CEILING_SECONDS: float = 7.5
DEFAULT_COLD_CEILING_SECONDS: float = 11.0
DEFAULT_WARM_CEILING_SECONDS: float = 4.0
DEFAULT_EDIT_CEILING_SECONDS: float = 6.0
