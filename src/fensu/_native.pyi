"""Type stubs for Fensu's private native extension."""
...
def select_native_execution_files(
    paths: list[str], includes: list[str], excludes: list[str], allow_empty: bool = False
...
def parse_dead_code_config(value: str) -> tuple[bool, list[tuple[list[str], list[str], str]]]: ...
def python_reachability_facts(
    sources: list[tuple[str, str, bool, bool]],
    entries: list[tuple[str, str]],
    version: tuple[int, int],
) -> tuple[
    list[tuple[int, str, str, int, int]], list[tuple[int, int]], list[tuple[int | None, str, str]]
]: ...
def symbol_pattern_matches(value: str, patterns: list[str]) -> bool: ...
def evaluate_python_reachability(
    graph: tuple[list[str], list[tuple[int, str, bool]], list[tuple[int, int]], list[int]],
    roots: list[tuple[list[str], list[str]]],
