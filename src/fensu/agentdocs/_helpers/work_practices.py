...
def work_practice_lines() -> tuple[str, ...]:
    ...
    return (
        ...
        "run full final verification. A request to make `fensu check` pass means fix the code "
        ...
        "",
        "Tests requiring real remote credentials or services such as external APIs or data warehouses "
...
def custom_rule_authority_lines() -> tuple[str, ...]:
    ...
    return (
        ...
        "",
        'An explicit request such as "create a custom rule preventing this" or "make Fensu '
        ...
        "rule is inconvenient, or changing policy would make `fensu check` pass. Fix code under "
