...
def navigation_workflow_lines() -> tuple[str, ...]:
    ...
    return (
        ...
        (
            ...
            "`fensu map <symbol> --depth 4` before editing. Rerun the same map after "
        ...
        "",
        (
            "After a substantial chunk of work, rerun `fensu check` and the same map. Include a "
