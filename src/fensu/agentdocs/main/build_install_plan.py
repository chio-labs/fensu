"""Build the pure expected Fensu skill installation plan."""

from __future__ import annotations

from pathlib import Path

from fensu.agentdocs._helpers.installation import build_install_targets, build_legacy_paths
from fensu.agentdocs._helpers.ownership import skill_input_fingerprint, skill_owner_key
