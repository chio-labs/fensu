...
from fensu.cache.storage.classes.native_cache_mutator import NativeCacheMutator
from fensu.cache.storage.constants import CACHE_DATABASE_RELATIVE_PATH, PARENT_PATH_PART
...
def _maximum_decoded_bytes() -> int:
    from fensu.cache.storage._helpers.serialization import CACHE_RECORD_MAX_DECODED_BYTES
