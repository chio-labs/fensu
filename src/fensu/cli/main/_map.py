...
from fensu.cache.mapping.main.build import build_cached_call_map
from fensu.cache.mapping.models import CachedCallMap, MapCacheStats
from fensu.cli._helpers.map_cache_status import write_map_cache_status
from fensu.cli.constants import NO_COLOR_ENVIRONMENT_VARIABLE
from fensu.cli.types import ColorMode
from fensu.mapping.exceptions import MapError
from fensu.mapping.main.build import build_call_map
from fensu.mapping.main.native import build_native_call_map
from fensu.mapping.main.render import render_call_tree
from fensu.mapping.main.resolve_project import resolve_mapping_project
from fensu.mapping.models import MappingProject
...
def _parser() -> argparse.ArgumentParser:
    parser: argparse.ArgumentParser = argparse.ArgumentParser(prog="fensu map")
