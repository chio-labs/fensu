"""Run the fensu rule-inspection command."""
...
from fensu.config.models import Config, LoadedConfig, RuleExceptionEntry
...
from fensu.reporting.constants import ANSI_BOLD_CYAN, ANSI_DIM, ANSI_RESET, REPORT_LINE_WIDTH
...
def _parser() -> argparse.ArgumentParser:
    parser: argparse.ArgumentParser = argparse.ArgumentParser(prog="fensu rule")
