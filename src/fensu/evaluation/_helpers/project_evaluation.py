...
from fensu.evaluation.classes.project_rule_context import PROJECT_REQUESTER_NAME, ProjectRuleContext
...
from fensu.rules.authoring.subjects import Project
...
def evaluate_project_rules(
    *,
    ...
    requester = tree.repo_root.path / PROJECT_REQUESTER_NAME
