"""Requester-bound observation recorder for serialized web fact queries."""
...
class WebDependencyObserver:
    """Record tree, graph, and web fact answers in one canonical shape."""
