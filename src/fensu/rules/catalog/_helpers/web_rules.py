...
_RULE_DETAILS: tuple[tuple[str, Family, str, str, str], ...] = (
    ...
    (
        ...
        "runtime modules live beneath explicit owners and roles",
        "Keep only recognized framework protocol and bootstrap files at the source root; move "
        "other modules beneath an owner and explicit role.",
    ),
    (
        "FWR306",
        Family.ROLES,
...
_CONSTRAINTS: dict[str, tuple[RuleConstraint, ...]] = {
    ...
    "FWR304": (
        ...
        RuleConstraint(
            name="recognized source-root protocols",
            description="Bootstrap, framework protocol, and declaration files allowed at a root",
            values=(
                "hooks.client.js",
                "hooks.client.ts",
                "hooks.js",
