...
from fensu.rules.exemplars._helpers.equivalent_rule import canonical_equivalent_rules
...
from fensu.rules.exemplars.main.tests._scenario_models import (
    scenario_models_dataclasses_equivalent,
)
...
NATIVE_CUSTOM_RULE_EQUIVALENTS: dict[str, RuleCheck] = canonical_equivalent_rules(
    {
        ...
        "FFT205": scenario_models_dataclasses_equivalent,
