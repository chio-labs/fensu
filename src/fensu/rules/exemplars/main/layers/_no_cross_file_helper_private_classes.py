...
from fensu import AttributeReferenceFact, Family, Fault, ImportFact, RuleContext, ScopeName, rule
...
def no_cross_file_helper_private_classes_equivalent(
    *, module: ast.Module, ctx: RuleContext
    ...
    """Express FFL110 through public scope and ordered reference facts."""
