...
from fensu.scaffolding.models import GitIgnorePlan
from fensu.scaffolding.types import GitIgnorePredicate
...
def plan_gitignore_update(*, repository: Path, greenfield: bool) -> GitIgnorePlan | None:
    """Capture a safe root gitignore update for enabled Fensu derived state."""
    ...
    if captured is None:
        ...
        return GitIgnorePlan(
            original=None,
            desired=prefix + FENSU_GITIGNORE_BLOCK,
            device=None,
            inode=None,
        )
