...
_thresholds_by_code: dict[str, tuple[Threshold, ...]] = {
    "SFR301": (Threshold.MAX_HELPERS_CONTAINER_MODULES, Threshold.MAX_ROLE_DEPTH),
    "SFR302": (Threshold.MAX_MAIN_CONTAINER_MODULES, Threshold.MAX_ROLE_DEPTH),
    "SFR308": (Threshold.MIN_SHARED_DOMAIN_PREFIX_PACKAGES,),
