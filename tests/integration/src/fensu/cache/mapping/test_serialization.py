...
from fensu.cache.mapping._helpers.fingerprints import file_declaration_identity
...
@pytest.mark.parametrize(
    ...
    [
        ...
        MappingIdentityTestCase(
            description="Fensu implementation changes file identity",
            field_name="fensu_implementation",
...
def test_given_mapping_identity_component_change_when_keying_file_then_identity_changes(
    ...
    identity: MappingIdentity = MappingIdentity(1, "CPython", "3.12.0", "fensu")
