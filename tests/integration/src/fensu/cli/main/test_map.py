"""Tests for deterministic `fensu map` output."""
...
@pytest.mark.parametrize(
    ...
    [
        StandaloneMapTestCase(
            description="src import root is inferred without Fensu configuration",
...
def test_given_repository_without_fensu_config_when_mapping_then_uses_project_roots(
    monkeypatch: pytest.MonkeyPatch,
    tmp_path: Path,
