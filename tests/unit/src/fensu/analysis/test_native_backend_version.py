...
import fensu.analysis.main.resolve_native_backend_version as version_module
...
from tests.unit.src.fensu.analysis._test_types import BackendUnavailableTestCase
from tests.unit.src.fensu.analysis.helpers import (
    FAKE_NATIVE_VERSION,
    fake_find_spec,
    fake_import_module,
)
...
@pytest.mark.parametrize(
    ...
    [
        BackendUnavailableTestCase(
            ...
            expected_message_fragment="Reinstall fensu",
        )
    ],
