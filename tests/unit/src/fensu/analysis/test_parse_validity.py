...
from tests.unit.src.fensu.analysis._test_types import ParseValidityTestCase
from tests.unit.src.fensu.analysis.helpers import cpython_parse_validity
...
def test_given_syntax_fixture_when_checking_both_parsers_then_validity_matches_expectations(
    ...
    native_valid: bool = (
        fensu_facts.check_syntax(test_case.source, sys.version_info[0], sys.version_info[1]) is None
    )
