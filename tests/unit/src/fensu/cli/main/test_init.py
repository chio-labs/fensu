"""Tests for the thin fensu init CLI adapter."""
...
from fensu.cli.main import _init as init_module
from fensu.scaffolding.models import InitOptions
from tests.unit.src.fensu.cli.main._test_types import InitAdapterTestCase, InitNoColorTestCase
