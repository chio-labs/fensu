"""Tests for the Fensu Memory command adapter."""
...
@pytest.mark.parametrize(
    ...
    [
        MemoryAdapterTestCase(
            ...
            argv=("--help",),
            expected_stdout=(
                "usage: fensu memory [-h] [--color {auto,always,never}]\n"
        ...
        MemoryAdapterTestCase(
            ...
            argv=("graph", "--help"),
            expected_stdout=(
                "usage: fensu memory graph [-h] [--direction {outbound,inbound,both}]\n"
...
@pytest.mark.parametrize(
    ...
    [
        MemoryDisabledAdapterTestCase(
            ...
            argv=(),
            expected_error_fragment="Fensu Memory is disabled",
