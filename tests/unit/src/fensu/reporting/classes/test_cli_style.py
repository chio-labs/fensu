...
from tests.unit.src.fensu.reporting.classes._test_types import CliStyleTestCase
    ...
    [
        CliStyleTestCase(
            ...
            expected_rendered=(
                ...
                "\033[1;32mWrote fensu.toml\033[0m|"
                "\033[38;5;208mFFA\033[0m|"
                "\033[1;38;5;208m12 faults\033[0m|"
                "\033[1;38;5;208mAction required\033[0m|"
                "\033[1;36mdocs.fensu.dev/adoption\033[0m"
            ),
        ),
        CliStyleTestCase(
            ...
            expected_rendered=(
                ...
                "Wrote fensu.toml|FFA|12 faults|Action required|"
                "docs.fensu.dev/adoption"
            ),
        ),
    ],
...
def test_given_color_setting_when_styling_cli_text_then_returns_exact_semantic_strings(
    ...
    rendered: str = "|".join(
        (
            ...
            style.success("Wrote fensu.toml"),
            style.family_fault_code("FFA"),
            style.fault_count("12 faults"),
            style.warning("Action required"),
            style.link("docs.fensu.dev/adoption"),
        )
    )
