...
@pytest.mark.parametrize(
    ...
    [
        ...
        RuleGrammarTestCase("native pack root prefix", "FP", False, True),
        RuleGrammarTestCase("Dagster pack prefix", "FPDG", False, True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        RuleSelectorMatchTestCase("pack root matches Dagster alias", "FPDGA001", "FP", True),
        RuleSelectorMatchTestCase("Dagster pack matches native rule", "FPDG001", "FPDG", True),
        RuleSelectorMatchTestCase("Dagster family matches alias", "FPDGA001", "FPDGA", True),
        RuleSelectorMatchTestCase("core root does not match pack alias", "FPDGA001", "FF", False),
