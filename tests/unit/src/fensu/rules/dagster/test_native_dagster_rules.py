...
@pytest.mark.parametrize(
    ...
    (
        ...
        NativeDagsterRuleTestCase(
            ...
            path="pkg/defs/jobs/commerce/example.py",
            expected_fault_count=1,
        ),
        NativeDagsterRuleTestCase(
        ...
        NativeDagsterRuleTestCase(
            ...
            path="pkg/defs/jobs/commerce/main.py",
            expected_fault_count=1,
        ),
        NativeDagsterRuleTestCase(
            description="private automation support imported outside owner faults",
            code="FPDG009",
            source="from pkg.defs.jobs.commerce._models import Plan\n",
            path="pkg/defs/assets/example/main.py",
            expected_fault_count=1,
        ),
        NativeDagsterRuleTestCase(
        ...
        NativeDagsterRuleTestCase(
            ...
            code="FPDG012",
            source="VALUE: int = 1\n",
            path="pkg/defs/resources/asset_configs/commerce/example.py",
            expected_fault_count=1,
        ),
        NativeDagsterRuleTestCase(
            description="dynamic project import faults once",
            code="FPDG013",
            source="from importlib import import_module\n\nmodule = import_module('pkg.defs.jobs.commerce')\n",
            path="pkg/defs/jobs/commerce/example.py",
            expected_fault_count=1,
        ),
        NativeDagsterRuleTestCase(
