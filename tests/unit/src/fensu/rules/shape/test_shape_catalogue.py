...
from tests.unit.src.fensu.rules.shape._test_types import (
    ShapeCatalogueTestCase,
    ShapeDefaultOffTestCase,
    ShapeGuidanceTestCase,
)
from tests.unit.src.fensu.rules.shape.helpers import shape_rule_by_code
...
def test_given_shape_rule_catalogue_when_reading_codes_then_matches_shape_code_enum(
    ...
    codes: tuple[str, ...] = tuple(rule.code for rule in FFS_RULES)
