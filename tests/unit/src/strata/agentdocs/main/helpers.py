...
from strata.rules.authoring.types import Family, RuleKind, Threshold
...
def generation_context(
    *,
    ...
    source_kind: ConfigSourceKind = ConfigSourceKind.STRATA_TOML,
    ...
    source_name: str = {
        ...
        ConfigSourceKind.STRATA_TOML: "strata.toml",
    }[source_kind]
...
def comprehensive_generation_context(*, reverse_mappings: bool = False) -> SkillGenerationContext:
    ...
    naming_rule: RuleSpec = core_rules_for_codes(("SFN001",))[0]
    warning_rule: RuleSpec = core_rules_for_codes(("SFR706",))[0]
    ignored_rule: RuleSpec = core_rules_for_codes(("SFH001",))[0]
...
def core_only_generation_context() -> SkillGenerationContext:
    ...
    rule: RuleSpec = core_rules_for_codes(("SFH001",))[0]
    return generation_context(
