...
from tests.unit.src.strata.analysis._test_types import FactBackendSelectionTestCase
...
@pytest.mark.parametrize(
    ...
    [
        ...
        FactBackendSelectionTestCase(
            description="default selection falls back to python without the native module",
            requested_value="",
        ...
        FactBackendSelectionTestCase(
            description="requesting native without the module warns and uses python",
            requested_value="native",
            native_available=False,
            expected_backend="python",
            expected_native_version=None,
