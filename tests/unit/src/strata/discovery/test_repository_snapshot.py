...
from strata.discovery.main.discover_files import _snapshot_relative_paths
from strata.discovery.models import RepoRoot, ScopedFile
from strata.discovery.types import ScopeName
from strata.instrumentation.constants import SNAPSHOT_ROOT_RELATIVIZE_OPERATION
