...
from strata.config.models import Config, EvaluationConfig, RuleExceptionEntry
...
from tests.unit.src.strata.evaluation._test_types import EvaluationContextSelectionTestCase
...
def test_given_excluded_context_when_evaluating_importer_then_retains_queries_and_boundary(
    ...
    boundary_rule: RuleSpec = layer_rule(code="SFL102")
