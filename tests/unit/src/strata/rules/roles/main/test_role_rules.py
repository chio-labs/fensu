...
@pytest.mark.parametrize(
    ...
    [
        ...
        SfrRuleTestCase(
            description="first token groups broad billing ownership",
            rule_code="SFR308",
            relative_path="__init__.py",
            source="",
            support_files=(
                SfrSupportFile(
                    description="billing annotation export domain",
                    relative_path="billing_annotation_export/__init__.py",
                    source="",
                ),
                SfrSupportFile(
                    description="billing annotation validation domain",
                    relative_path="billing_annotation_validation/__init__.py",
                    source="",
                ),
                SfrSupportFile(
                    description="billing events domain",
                    relative_path="billing_events/__init__.py",
                    source="",
                ),
            ),
            expected_codes=("SFR308",),
        ...
        SfrRuleTestCase(
            ...
            support_files=(
                SfrSupportFile(
                    description="first billing domain",
                    relative_path="billing_api/__init__.py",
                    source="",
                ),
                SfrSupportFile(
                    description="second billing domain",
                    relative_path="billing_events/__init__.py",
                    source="",
                ),
            ),
...
@pytest.mark.parametrize(
    ...
    [
        SfrRuleTestCase(
            ...
            expected_lines=(None,),
            expected_messages=(
                "sibling domains billing_annotation_export, "
                "billing_annotation_validation, and billing_events share the "
                "billing_ owner prefix",
            ),
            expected_remediations=(
                "Create billing/ and move them beneath it as annotation_export/, "
        ...
        SfrRuleTestCase(
            ...
            support_files=(
                SfrSupportFile(
                    description="existing billing domain",
                    relative_path="billing/models.py",
                    source="",
                ),
                SfrSupportFile(
                    description="billing annotation domain",
                    relative_path="billing_annotation/__init__.py",
                    source="",
                ),
                SfrSupportFile(
                    description="billing events domain",
            ...
            expected_lines=(None,),
            expected_messages=(
                "sibling domains billing_annotation and billing_events share the "
                "billing_ owner prefix",
            ),
            expected_remediations=(
                "Move them under the existing billing/ domain as annotation/ and events/ "
                "subdomains.",
            ),
            expected_paths=("src/pkg/__init__.py",),
        ),
