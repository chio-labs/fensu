...
from strata.scaffolding.core.types import CandidateProvenance
...
def atomic_link_racer(*, destination_kind: str) -> Callable[..., None]:
    """Return an os.link replacement that creates a commerce destination."""
