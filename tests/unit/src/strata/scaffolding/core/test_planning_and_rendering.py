...
from strata.scaffolding.core.helpers.output import normalize_project_name
...
from strata.scaffolding.core.models import InitOptions, InitPlan
from strata.scaffolding.core.types import AdoptionMode, InteractionDecision
